...
| Настройки | экономика (в т.ч. `referral_min_piarflow_subs`, валютный emoji), антитвинк и операционные флаги — **без перезапуска**; валюту можно вставить как custom_emoji из чата |
